...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * menu (sizes are 20, 40, 80 and 100). Requires pagination (`paginate`).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Features
		...
		"oLanguage": {
			 ...
			 * with a default select list of 20, 40, 80 and 100, and can be replaced
