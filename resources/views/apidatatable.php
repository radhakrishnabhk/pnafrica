...
<html lang="en">
	...
	<script src="<?php echo 'http://localhost/clinicapp/'; ?>lib/jquery.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
		
		<link rel="stylesheet" type="text/css" href="<?php 
		$libPath = 'http://localhost/clinicapp/';
		
		echo $libPath; ?>lib/jquery.dataTables.css">
		<style type="text/css" class="init">
		</style>
		<script type="text/javascript" language="javascript" src="<?php echo $libPath; ?>lib/jquery.dataTables.js"></script>
	...
	<script>
	var app = angular.module('apidatatable', []).config(['$httpProvider', function($httpProvider) {
...
<a href='<?php echo $libPath."health"  ?>'>Hospital Data</a>&nbsp;&nbsp;&nbsp;&nbsp;

<a href='<?php echo $libPath."doctors"  ?>'>Doctors Data</a>
...
table.dataTable thead .sorting {
  background-image: url('<?php echo $libPath; ?>lib/sort_both.png');
}
table.dataTable thead .sorting_asc {
  background-image: url("<?php echo $libPath; ?>lib/sort_asc.png");
}
table.dataTable thead .sorting_desc {
  background-image: url("<?php echo $libPath; ?>lib/sort_desc.png");
}
table.dataTable thead .sorting_asc_disabled {
  background-image: url("<?php echo $libPath; ?>lib/sort_asc_disabled.png");
}
table.dataTable thead .sorting_desc_disabled {
  background-image: url("<?php echo $libPath; ?>lib/sort_desc_disabled.png");
}
</style>
</body>
</html>